...
const App: React.FC = () => {
  ...
  return (
    <div className="flex h-screen md:h-screen supports-[height:100dvh]:h-[100dvh] bg-slate-900 text-slate-100 font-sans overflow-hidden" dir="rtl">
      <Sidebar 
      ...
      />
      <div className="flex-grow flex flex-col h-full w-full overflow-hidden relative transition-all duration-300 bg-slate-900">
        <Header 
          onMenuClick={() => setIsSidebarOpen(true)}
          activeViewLabel={viewLabels[activeView]}
        />
        <main className="flex-grow overflow-y-auto scroll-smooth relative w-full bg-slate-900">
          {renderActiveView()}
        </main>
